<?php /* Smarty version Smarty-3.1.19, created on 2016-08-11 00:25:50
         compiled from "C:\xampp\htdocs\shop\themes\theme593\modules\blocklayered\blocklayered.tpl" */ ?>
<?php /*%%SmartyHeaderCode:1561157ac0c5ede1d55-15591516%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_valid = $_smarty_tpl->decodeProperties(array (
  'file_dependency' => 
  array (
    'b139d2f3baab5c1ff64adf0a123267da406ea720' => 
    array (
      0 => 'C:\\xampp\\htdocs\\shop\\themes\\theme593\\modules\\blocklayered\\blocklayered.tpl',
      1 => 1470891329,
      2 => 'file',
    ),
  ),
  'nocache_hash' => '1561157ac0c5ede1d55-15591516',
  'function' => 
  array (
  ),
  'variables' => 
  ...
  'unifunc' => 'content_57ac0c5f1c4513_98861402',
),false); /*/%%SmartyHeaderCode%%*/?>
<?php if ($_valid && !is_callable('content_57ac0c5f1c4513_98861402')) {function content_57ac0c5f1c4513_98861402($_smarty_tpl) {?><!-- Block layered navigation module -->
...
<section id="layered_block_left" class="column_box block">
	<h4 class="toggle"><span><?php echo smartyTranslate(array('s'=>'Filter','mod'=>'blocklayered'),$_smarty_tpl);?>
...
<?php echo smartyTranslate(array('s'=>':','mod'=>'blocklayered'),$_smarty_tpl);?>
 ...
 - 
												...
												<?php } else { ?>
													<?php echo htmlspecialchars($_smarty_tpl->tpl_vars['filter']->value['values'][0], ENT_QUOTES, 'UTF-8', true);?>
<?php echo htmlspecialchars($_smarty_tpl->tpl_vars['filter']->value['unit'], ENT_QUOTES, 'UTF-8', true);?>
 - 
													<?php echo htmlspecialchars($_smarty_tpl->tpl_vars['filter']->value['values'][1], ENT_QUOTES, 'UTF-8', true);?>
<?php echo htmlspecialchars($_smarty_tpl->tpl_vars['filter']->value['unit'], ENT_QUOTES, 'UTF-8', true);?>
...
', <?php echo $_smarty_tpl->tpl_vars['filter']->value['format'];?>
							...
							<?php } else { ?>
								<?php if ($_smarty_tpl->tpl_vars['filter']->value['filter_type']==1) {?>
								<li class="nomargin">
									<span><?php echo smartyTranslate(array('s'=>'From','mod'=>'blocklayered'),$_smarty_tpl);?>
</span> <input class="layered_<?php echo $_smarty_tpl->tpl_vars['filter']->value['type'];?>
...
_range_unit"><?php echo $_smarty_tpl->tpl_vars['filter']->value['unit'];?>
									...
									<span><?php echo smartyTranslate(array('s'=>'to','mod'=>'blocklayered'),$_smarty_tpl);?>
</span> <input class="layered_<?php echo $_smarty_tpl->tpl_vars['filter']->value['type'];?>
...
" />
	...
	<div id="layered_ajax_loader" style="display: none; text-align:center;">
		<p style="position:absolute; left:45%; top:20px;"><img src="<?php echo $_smarty_tpl->tpl_vars['img_dir']->value;?>
