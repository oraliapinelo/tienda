...
<h1><span>{if !isset($email_create)}{l s='Log in'}{else}{l s='Create your account'}{/if}</span></h1>
...
{if !isset($email_create)}
	...
	<form action="{$link->getPageLink('authentication', true)}" method="post" id="create-account_form" class="std span6">
        ...
        <div class="titled_box">
			<h2><span>{l s='Create your account'}</span></h2>
			<div class="form_content clearfix">
				<h4>{l s='Enter your e-mail address to create an account'}.</h4>
				<div class="error alert alert-error clearfix" id="create_account_error" style="display:none"></div>
				<p class="text">
			...
			<div class="form_content clearfix">
				...
				<p class="submit">
					...
					<input type="submit" id="SubmitLogin" name="SubmitLogin" class="button" value="{l s='Log in'}" />
                				...
                				<p class="lost_password title_shop"><a class="button " href="{$link->getPageLink('password')}">{l s='Forgot your password?'}</a></p>
			</div>
            </div>
		</fieldset>
	</form>
...
<form action="{$link->getPageLink('authentication', true)}" method="post" id="account-creation_form" class="std">
	...
	<fieldset class="account_creation titled_box">
		...
		<p class="required password clearfix">
			<label for="passwd">{l s='Password'} <sup>*</sup><span class="form_info fr">{l s='(5 characters min.)'}</span></label>
