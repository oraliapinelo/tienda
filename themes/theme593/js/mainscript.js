...
$(window).load(function () {
      $(function(){
      	 $("#contact_form #fileUpload, .compare .comparator,#layered_form #ul_layered_quantity_0 input,#layered_form #ul_layered_quantity_0 ckeckbox, #ul_layered_condition_0 input,ul_layered_id_attribute_group_3 input,#ul_layered_id_attribute_group_3 input").uniform();
