...
{else}
	<span class="title-pagecontact"><i class="icon-comment-alt"></i>{l s='For questions about an order or for more information about our products'}.</span>
	...
	<form id="contact_form" action="{$request_uri|escape:'htmlall':'UTF-8'}" method="post" class="std" enctype="multipart/form-data">
		...
		<p class="submit">
			<input  class="button" type="submit" name="submitMessage" id="submitMessage" value="{l s='Send'}"  onclick="$(this).hide();" />
		</p>
        </div>
	</fieldset>
</form>
